...
\input{capitulos/capitulo-1.tex}
\input{capitulos/capitulo-2.tex}
\input{capitulos/capitulo-3.tex}
\input{capitulos/capitulo-4.tex}
...
\appendix
\input{apendices/apendice-a-analisis}
\input{apendices/apendice-b-especificacion-modelo-de-clases}
\input{apendices/apendice-c-diagramas-de-secuencia}
\input{apendices/apendice-d-especificacion-requisitos-interfaz}
\input{apendices/apendice-e-diseño-de-clases}
\input{apendices/apendice-f-diagrama-de-paquetes}
\input{apendices/apendice-g-diseño-de-la-interfaz}
